...
apollo_config_db_url=jdbc:mysql://10.19.250.62:30202/apollo_config_dev?useSSL=false
apollo_config_db_username=root
apollo_config_db_password=Facethink2016

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://10.19.250.62:30202/apollo_portal?useSSL=false
apollo_portal_db_username=root
apollo_portal_db_password=Facethink2016

#meta server url, different environments should have different meta server addresses
dev_meta=http://godeye-apollo-config:8768
fat_meta=http://godeye-apollo-config:8768
uat_meta=http://godeye-apollo-config:8768
pro_meta=http://godeye-apollo-config:8768
