...
import com.ctrip.framework.foundation.internals.provider.DefaultTimeoutProvider;
...
public class DeferredResultWrapper {
  ...
  private DefaultTimeoutProvider defaultTimeoutProvider = new DefaultTimeoutProvider();
  ...
  public DeferredResultWrapper() {
    defaultTimeoutProvider.initialize();
    timeout = Long.parseLong(defaultTimeoutProvider.getTimeout());
